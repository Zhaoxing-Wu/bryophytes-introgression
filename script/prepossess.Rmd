...
```{r}
df = read_excel("./orig_data/Snaq_voucher_28022023.xlsx")
df = na.omit(df)
...
write.csv(df, "mapping.csv")
```

```{r}
file <- paste(readLines("./orig_data/SnAq_Bryophyte_Introgression/Astral_allbryos_G_Jul2021_GeneTrees_rooted.nex"), collapse="\n")
